...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ATTENTION_COMPRESS_RATIO,               "%s.attention.layer_compress_ratio"         },
    ...
    { LLM_KV_ROPE_FREQ_BASE_COMPRESS,        "%s.rope.freq_base_compress"              },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_COMPRESSOR_APE,                    "blk.%d.attn_compressor.ape" },
    { LLM_TENSOR_ATTN_COMPRESSOR_NORM,                   "blk.%d.attn_compressor.norm" },
    { LLM_TENSOR_ATTN_COMPRESSOR_WGATE,                  "blk.%d.attn_compressor.wgate" },
    { LLM_TENSOR_ATTN_COMPRESSOR_WKV,                    "blk.%d.attn_compressor.wkv" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_NEXTN_HC_HEAD_FN,           {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NEXTN_HC_HEAD_BASE,         {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_ADD}},
    {LLM_TENSOR_NEXTN_HC_HEAD_SCALE,        {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    // Nemotron 3 Super
